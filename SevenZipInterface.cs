...
namespace SevenZipExtractor
{
    ...
    internal struct PropArray
    {
        ...
        private readonly IntPtr pointerValues;
    }
    ...
    */
    ...
    internal interface IInArchive
    {
        ...
        int Extract(
            ...
            uint[] indices, //[In] ref uint indices,
            uint numItems,
            int testMode,
    ...
    internal class InStreamTimedWrapper : StreamWrapper, ISequentialInStream, IInStream
    {
        ...
        private readonly string BaseStreamFileName;
            ...
            : base(baseStream)
        {
            if (BaseStream is FileStream && !BaseStream.CanWrite && BaseStream.CanSeek)
            {
                ...
                CloseTimer = new Timer(CloseStream, null, KeepAliveInterval, Timeout.Infinite);
            }
        }
        ...
        private void CloseStream(object state)
        {
            ...
            if (BaseStream != null)
            {
                if (BaseStream.CanSeek) BaseStreamLastPosition = BaseStream.Position;
                BaseStream.Close();
                BaseStream = null;
            }
        }
    ...
    internal class OutStreamWrapper : StreamWrapper, ISequentialOutStream, IOutStream
    {
        ...
        public int Write(byte[] data, uint size, IntPtr processedSize)
        {
            ...
            if (processedSize != IntPtr.Zero) Marshal.WriteInt32(processedSize, (int) size);
            return 0;
        }
    }
}