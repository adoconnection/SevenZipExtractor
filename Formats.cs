...
namespace SevenZipExtractor
{
    ...
    {
        internal static readonly Dictionary<string, SevenZipFormat> ExtensionFormatMapping =
            new Dictionary<string, SevenZipFormat>
            {
                ...
                {"gm", SevenZipFormat.Lzma} // For Garry's Mod addons
            };
